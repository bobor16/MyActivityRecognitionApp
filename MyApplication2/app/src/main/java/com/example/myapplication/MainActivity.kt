...
import com.example.myapplication.Constants.ACTIVITY_TRANSITION_STORAGE
...
class MainActivity : AppCompatActivity(), EasyPermissions.PermissionCallbacks {
    ...
    //call the removeActivityTransitionUpdates() method of the ActivityRecognitionClient and pass ourPendingIntent object as a parameter
    ...
    //creates and returns the PendingIntent object which holds an Intent to an BroadCastReceiver class
